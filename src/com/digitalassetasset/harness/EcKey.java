...
public class EcKey {
    public static void main(String[] args) {
        try {
            Backend backend = new HttpBackend("http://localhost:12345", 10);
            ...
            short id = AsymmetricKeyEc.importKey(session, (short) 0, "test_ec_key", Arrays.asList(1, 2, 3), Algorithm.EC_P256, Arrays.asList(
                    Capability.SIGN_ECDSA), (ECPrivateKey) keypair.getPrivate());
            AsymmetricKeyEc ecKey = new AsymmetricKeyEc(id, Algorithm.EC_P256);
